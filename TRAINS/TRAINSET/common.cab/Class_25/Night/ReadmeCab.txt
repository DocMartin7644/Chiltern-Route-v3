...
Night Cabview for Class 25 Diesel-Electric locomotive.
...
Unzip 25nightcab.zip to a temporary folder.
...
To install into the common.cab, make a new folder within the common.cab folder named Class25-1

Copy all the ace files to the new Class25-1 folder.

Copy the class25cn.cvf file to your loco cabview folder.


Check the Cabview ( xxxxxx.cvf ) parameter in the loco eng file:


Cabview installed: Eng file needs to be:     Cabview ( class25n.cvf )

Common.cab installed: Eng file needs to be:  Cabview ( class25cn.cvf )
...
and advice given with respecting the Class 25 loco operation and controls.
