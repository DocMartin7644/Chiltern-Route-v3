...
Cabview for Class 25 Diesel-Electric Locomotive.
...
Unzip Class25cab.zip to a temporary folder.
...
Copy the Class25c.cvf file to your loco cabview folder.


Check the Cabview ( xxxxxx.cvf ) parameter in the loco eng file:


Cabview installed: Eng file needs to be:     Cabview ( Class25.cvf )

Common.cab installed: Eng file needs to be:  Cabview ( Class25c.cvf )
