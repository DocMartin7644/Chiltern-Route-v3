...
Cabview for Class 31 Diesel-Electric Locomotive.

Version 1.0 First release
Version 1.1 Updated: Modifications to brake controls.
...
Unzip Class31cab.zip to a temporary folder.
...
To install into the common.cab, make a new folder within the common.cab folder named Class31-1

Copy all the ace files to the new Class31-1 folder.

Copy the class31c.cvf file to your loco cabview folder.


Check the Cabview ( xxxxxx.cvf ) parameter in the loco eng file:


Cabview installed: Eng file needs to be:     Cabview ( class31.cvf )

Common.cab installed: Eng file needs to be:  Cabview ( class31c.cvf )
...
and advice given with respecting the Class 31 loco operation and controls.
