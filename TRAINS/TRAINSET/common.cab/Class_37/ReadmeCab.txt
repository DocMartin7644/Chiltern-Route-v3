...
Cabview for Class 37 Diesel-Electric Locomotive.
...
Unzip Class37-1cab.zip to a temporary folder.
...
To install into the common.cab make a new folder within the common.cab folder named Class37-1

Copy all the ace files to the new Class37-1 folder.

Copy the class37c.cvf file to your loco cabview folder.


Check the Cabview ( xxxxxx.cvf ) parameter in the loco eng file:


Cabview installed: Eng file needs to be:     Cabview ( class37.cvf )

Common.cab installed: Eng file needs to be:  Cabview ( class37c.cvf )
...
and advice given with respecting the Class 37 loco operation and controls.
