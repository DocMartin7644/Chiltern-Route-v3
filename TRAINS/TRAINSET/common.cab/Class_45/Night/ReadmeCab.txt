...
Night Cabview for Class 45 Diesel-Electric locomotive.

Version 1.0 First release
Version 1.1 Updated: Modifications to brake controls and vacuum gauge.
...
Unzip 45nightcab.zip to a temporary folder.
...
To install into the common.cab, make a new folder within the common.cab folder named Class45-1

Copy all the ace files to the new Class45-1 folder.

Copy the class45cn.cvf file to your loco cabview folder.


Check the Cabview ( xxxxxx.cvf ) parameter in the loco eng file:


Cabview installed: Eng file needs to be:     Cabview ( class45n.cvf )

Common.cab installed: Eng file needs to be:  Cabview ( class45cn.cvf )
...
and advice given with respecting the Class 45 loco operation and controls.
