...
Cabview for Class 45 Diesel-Electric Locomotive.
...
Unzip Class45cab.zip to a temporary folder.
...
Copy the class45c.cvf file to your loco cabview folder.


Check the Cabview ( xxxxxx.cvf ) parameter in the loco eng file:


Cabview installed: Eng file needs to be:     Cabview ( class45.cvf )

Common.cab installed: Eng file needs to be:  Cabview ( class45c.cvf )
