...
Cabview for Class 47 Diesel-Electric Locomotive.

Version 1.0 First release
Version 1.1 Updated: Modifications to engine brake control.
...
Unzip Class47cab.zip to a temporary folder.
...
To install into the common.cab, make a new folder within the common.cab folder named Class47

Copy all the ace files to the new Class47 folder.

Copy the class47c.cvf file to your loco cabview folder.


Check the Cabview ( xxxxxx.cvf ) parameter in the loco eng file:


Cabview installed: Eng file needs to be:     Cabview ( class47.cvf )

Common.cab installed: Eng file needs to be:  Cabview ( class47c.cvf )
...
Barrowhill Roundhouse for granting me permission to take photographs
and advice given with respecting the Class 47 loco operation and controls.

Ray Mathers - for help and advice.
Dominic Mathers - technical assistance.
