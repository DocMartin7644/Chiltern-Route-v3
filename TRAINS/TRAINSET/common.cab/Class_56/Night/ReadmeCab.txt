...
Night Cabview for Class 56 Diesel-Electric locomotive.
...
Unzip 56nightcab.zip to a temporary folder.
...
To install into the common.cab, make a new folder within the common.cab folder named Class56

Copy all the ace files to the new Class56 folder.

Copy the class56cn.cvf file to your loco cabview folder.


Check the Cabview ( xxxxxx.cvf ) parameter in the loco eng file:


Cabview installed: Eng file needs to be:     Cabview ( class56n.cvf )

Common.cab installed: Eng file needs to be:  Cabview ( class56cn.cvf )
...
and advice given with respecting the Class 56 loco operation and controls.
