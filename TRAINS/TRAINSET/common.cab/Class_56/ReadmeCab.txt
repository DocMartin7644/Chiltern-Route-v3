...
Cabview for Class 56 Diesel-Electric Locomotive.
...
Unzip Class56cab.zip to a temporary folder.
...
Copy the Class56c.cvf file to your loco cabview folder.


Check the Cabview ( xxxxxx.cvf ) parameter in the loco eng file:


Cabview installed: Eng file needs to be:     Cabview ( Class56.cvf )

Common.cab installed: Eng file needs to be:  Cabview ( Class56c.cvf )
