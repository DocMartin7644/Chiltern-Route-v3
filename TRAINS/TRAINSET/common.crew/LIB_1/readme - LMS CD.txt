...
For Ivatt Tank add:
	...
	FreightAnim ( "..\\common.crew\\LIB_1\\IvattTank.s" 0.01 0.01 )

For Ivatt Tender add:

	FreightAnim ( "..\\common.crew\\LIB_1\\IvattTender.s" 0 3.0 0.0 )

For Drummond "Barney" 0-6-0 add:

	FreightAnim ( "..\\common.crew\\LIB_1\\Barney.s" 0.1 0.1 )

For Drummond "Small Ben" 4-4-0 add:

	FreightAnim ( "..\\common.crew\\LIB_1\\SmallBen.s" 0.1 0.1 )

For HR Passenger Tank add:

	FreightAnim ( "..\\common.crew\\LIB_1\\HRPT.s" 0.1 0.1 )
