...
DieselEngineMaxRPMChangeRate( )   statement set to at least 75, preferably 100, ie
	...
	DieselEngineMaxRPMChangeRate( 75 )
...
Simply run the self installer file SmallShunterSndsV1-0.exe 

This will create (or use) two folders in the Trainset folder; common.sound/BrClass07 and common.sound/uk_shared 
...
Wagon () section:
     ...
     Sound ( "..\\..\\common.sound\\BrClass07\\brclass07eng01.sms" )

Engine () section:

     Sound ( "..\\..\\common.sound\\BrClass07\\brclass07cab01.sms" )
...
Wagon () section:
     ...
     Sound ( "..\\..\\common.sound\\BrClass07\\brclass07eng02.sms" )

Engine () section:

     Sound ( "..\\..\\common.sound\\BrClass07\\brclass07cab02.sms" )
...
Wagon () section:
     ...
     Sound ( "..\\..\\common.sound\\BrClass07\\#brclass07.sms" )
